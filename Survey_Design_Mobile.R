...
server <- function(input, output) {
  ...
  output$random_choices1 <- renderUI(radioButtons("Choice1",
                                                        "Which product do you prefer ? ",
                                                        s1,
  ))
  
  output$random_choices2 <- renderUI(radioButtons("Choice2",
                                                        "Which product do you prefer ? ",
                                                        s2,
  ))
  output$random_choices3 <- renderUI(radioButtons("Choice3",
                                                        "Which product do you prefer ?",
                                                        s3,
  ))
  
  output$random_choices4 <- renderUI(radioButtons("Choice4",
                                                        "Which product do you prefer ? ",
                                                        s4,
  ))
  output$random_choices5 <- renderUI(radioButtons("Choice5",
                                                        "Which product do you prefer ? ",
                                                        s5,
  ))
  
  output$random_choices6 <- renderUI(radioButtons("Choice6",
                                                        "Which product do you prefer ? ",
                                                        s6,
  ))
  output$random_choices7 <- renderUI(radioButtons("Choice7",
                                                        "Which product do you prefer ? ",
                                                        s7,
  ))
  
  output$random_choices8 <- renderUI(radioButtons("Choice8",
                                                        "Which product do you prefer ? ",
                                                        s8,
  ))
  output$random_choices9 <- renderUI(radioButtons("Choice9",
                                                        "Which product do you prefer ? ",
                                                        s9,
  ))
  
  output$random_choices10 <- renderUI(radioButtons("Choice10",
                                                         "Which product do you prefer ? ",
                                                         s10,
  ))
  
  output$random_choices11 <- renderUI(radioButtons("Choice11",
                                                         "Which product do you prefer ?",
                                                         s11,
  ))
  
  output$random_choices12 <- renderUI(radioButtons("Choice12",
                                                         "Which product do you prefer ?",
                                                         s12,
  ))
